...
<html lang="en">
<?php 
    include '../../action/pembayaran_action/show_detail_pembayaran.php';
?>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="card-title d-flex justify-content-center">Edit Pembayaran</h5>
                                <form action="../../action/pembayaran_action/update_pembayaran_act.php" method="post" class="mt-5">
                                    <div class="mb-3">
