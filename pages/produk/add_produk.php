                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="card-title d-flex justify-content-center">Add Produk</h5>
                                <form action="../../action/produk_action/insert_produk_act.php" method="post" class="mt-5" enctype="multipart/form-data">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputtext1" aria-describedby="textHelp" name="stok" >
                                    </div>
